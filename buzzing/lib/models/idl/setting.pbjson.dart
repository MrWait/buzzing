...
@$core.Deprecated('Use localSettingGetRequestDescriptor instead')
const LocalSettingGetRequest$json = {
  '1': 'LocalSettingGetRequest',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
  ],
};

/// Descriptor for `LocalSettingGetRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List localSettingGetRequestDescriptor = $convert
    .base64Decode('ChZMb2NhbFNldHRpbmdHZXRSZXF1ZXN0EhAKA2tleRgBIAEoCVIDa2V5');

@$core.Deprecated('Use localSettingGetResponseDescriptor instead')
const LocalSettingGetResponse$json = {
  '1': 'LocalSettingGetResponse',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
...
/// Descriptor for `LocalSettingGetResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List localSettingGetResponseDescriptor =
    $convert.base64Decode(
        'ChdMb2NhbFNldHRpbmdHZXRSZXNwb25zZRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIA'
        'EoCVIFdmFsdWU=');

@$core.Deprecated('Use localSettingSetRequestDescriptor instead')
const LocalSettingSetRequest$json = {
  '1': 'LocalSettingSetRequest',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    {'1': 'value', '3': 2, '4': 1, '5': 9, '10': 'value'},
  ],
...
/// Descriptor for `LocalSettingSetRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List localSettingSetRequestDescriptor =
    $convert.base64Decode(
        'ChZMb2NhbFNldHRpbmdTZXRSZXF1ZXN0EhAKA2tleRgBIAEoCVIDa2V5EhQKBXZhbHVlGAIgAS'
        'gJUgV2YWx1ZQ==');

@$core.Deprecated('Use localSettingSetResponseDescriptor instead')
const LocalSettingSetResponse$json = {
  '1': 'LocalSettingSetResponse',
};

/// Descriptor for `LocalSettingSetResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List localSettingSetResponseDescriptor =
    $convert.base64Decode('ChdMb2NhbFNldHRpbmdTZXRSZXNwb25zZQ==');
