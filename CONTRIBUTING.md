# Contributing to buzzing

感谢你对本项目的关注！

## ⚠️ Contributor License Agreement (CLA)
This project uses BSL‑1.1 source‑available license.
In order for us to accept your source‑code changes, you must agree to the **Individual Contributor License Agreement (ICLA)**.

By opening a Pull Request containing source‑code, you automatically accept the terms described in [CLA.md](./CLA.md).
